...
const Banner = () => {
  return (
    <div className=" banner-section flex flex-col justify-center items-center relative h-[680px] bg-red-500 mb-28">
      ...
      <div className="flex flex-col gap-10 lg:flex-row justify-between items-center w-full px-20 z-20">
        <div className="banner-left-side flex flex-col gap-5 items-start max-w-60 text-white">
