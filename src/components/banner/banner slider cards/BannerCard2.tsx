...
const BannerCard2 = () => {
  return (
    <div className=" banner-section-2 flex flex-col justify-center items-center relative h-[680px]  lg:my-10 relative">
      ...
      <div className="flex flex-col gap-10 md:flex-row justify-between items-center w-full px-20 z-20">
        ...
        <div className="banner-left-side flex flex-col gap-5 items-start max-w-60 text-white banner-left z-40">
          ...
          <button className="btn bg-[#F565B0] font-semibold rounded-none text-white text-lg border-none hover:btn-neutral z-40">
            Shop Now
          </button>
        </div>
      </div>
